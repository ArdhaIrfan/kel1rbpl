            ...
            <div class="row alingn-items-start">
                <div class="column column1 border-end">
                    <div class="sidenav " id="myTab" role="tablist">
                        <a href="/profil/ubah" class="@yield('tab-ubah')"><img class="me-3" style="width: 20px" src="/gambar_modul/user.png" alt=""><i class="fas fa-user-tie @yield('tab-ubah')"></i>Ubah Profil</a>
                        <a href="/profil/langganan" class="@yield('tab-langganan')"><img class="me-3" style="width: 20px" src="/gambar_modul/langganan.png" alt=""><i class="fas fa-user-tie @yield('tab-langganan')"></i>Langganan</a>
                        <a href="/profil/setting" class="@yield('tab-setting')"><img class="me-3" style="width: 20px" src="/gambar_modul/settings.png" alt=""><i class="far fa-clipboard"></i>Settings</a>
                      </div>
                </div>
