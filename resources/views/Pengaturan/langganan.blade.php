...
/* Required meta tags */
    <meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">< !-- Bootstrap 5 CDN --><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">< !-- Document Styling --><link rel="stylesheet" href="styles.css" />< !-- Google Font Family --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;500;700&display=swap" rel="stylesheet"><title>IDe - IlmuDewantara Pricing </title>'
    ...
    <div class="row scroll-x">
            ...
            <div class="card shadow-lg active">
                ...
                <div class="card-body text-center">
                    <a class="btn btn-lg px-4 fw-bold btn-active"
                        style="border-radius:5px; font-size: 1rem; color:black;" href="/subscription/metode/4">Beli
                        Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class=" col-3 mb-4">
            <div class="card shadow-lg">
                ...
                <div class="card-body text-center">
                    <a class="btn btn-lg px-4 fw-bold btn-active"
                        style="border-radius:5px; font-size: 1rem; color:black;" href="/subscription/metode/3">Beli
                        Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class=" col-3 mb-4">
            <div class="card shadow-lg">
                ...
                <div class="card-body text-center">
                    <a class="btn btn-lg px-4 fw-bold btn-active"
                        style="border-radius:5px; font-size: 1rem; color:black;" href="/subscription/metode/2">Beli
                        Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class="col-3 mb-4">
            <div class="card shadow-lg">
                ...
                <div class="card-body text-center">
                    <a class="btn btn-lg px-4 fw-bold btn-active"
                        style="border-radius:5px; font-size: 1rem;  color:black;" href="/subscription/metode/1">Beli
                        Sekarang
                    </a>
                </div>
            </div>
